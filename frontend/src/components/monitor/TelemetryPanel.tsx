...
export function TelemetryPanel() {
  ...
  return (
    <div className="flex flex-col gap-4 w-full xl:w-80 shrink-0 min-h-0 xl:h-full overflow-y-auto xl:pl-2">
      <div className="grid grid-cols-2 gap-2 shrink-0">
        ...
        <Card className="bg-zinc-950/50 border-zinc-800 col-span-2 shrink-0">
      ...
      <Card className="bg-zinc-950/50 border-zinc-800 flex-1 flex flex-col min-h-[200px] shrink-0">
        ...
        <CardContent className="p-0 flex-1 relative">
          <ScrollArea className="absolute inset-0 p-4">
            <div className="space-y-2 font-mono text-[10px] text-zinc-300 leading-tight">
              ...
              {logs.map((log) => (
                <div key={log.slice(0, 23)} className={
